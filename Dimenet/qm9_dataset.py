...
class QM9(InMemoryDataset):
    ...
    types = {'H': 0, 'C': 1, 'N': 2, 'O': 3, 'F': 4, 'Cl': 5, 'Br': 6, 'S': 7, 'P': 8, 'I': 9, 'Si': 10, 'Li': 11, 'B': 12, 'Ge': 13}
    symbols = {'H': 1, 'C': 6, 'N': 7, 'O': 8, 'F': 9, 'Cl': 17, 'Br': 35, 'S': 16, 'P': 15, 'I': 53, 'Si': 14, 'Li': 3, 'B': 5, 'Ge': 32}
    ...
    def process(self):
        ...
        for i, mol in enumerate(tqdm(suppl)):
            ...
            try:
                ...
                weight = MolWt(Chem.MolFromSmiles(smi))
            except:
                weight = 0
                #print("error@@@@@@@@@@@@")
